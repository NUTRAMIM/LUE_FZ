...
// ---------------------------------------------------------------------------
// SSRF guard: a URL do catálogo vem do usuário (import) ou é persistida (cron).
// Sem validação, o servidor podia ser induzido a buscar endpoints internos da
// infra (metadata cloud 169.254.169.254, serviços internos do EasyPanel, etc).
// ---------------------------------------------------------------------------
